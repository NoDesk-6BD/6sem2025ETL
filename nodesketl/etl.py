...
from loader import (
    load_data,
    load_user_personal_data,
    load_agent_personal_data,
    load_agents_roles,
)
...
def run_etl():
    ...
    try:
        ...
        raw_data["TicketInteractions"] = extract_table(
            "TicketInteractions",
            [
                "InteractionId",
                "TicketId",
        ...
        raw_data["Attachments"] = extract_table(
            "Attachments",
            [
                "AttachmentId",
                "TicketId",
        ...
        raw_data["TicketStatusHistory"] = extract_table(
            "TicketStatusHistory",
            [
                "HistoryId",
                "TicketId",
        ...
        raw_data["AuditLogs"] = extract_table(
            "AuditLogs",
            [
                "AuditId",
                "EntityType",
        ...
        load_data(
            "SLA_Plans",
            raw_data["SLA_Plans"],
            ["SLAPlanId", "Name", "FirstResponseMins", "ResolutionMins"],
        )
